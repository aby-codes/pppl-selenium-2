...
public class LoginTest {
    ...
    public void testLogin() {
        ...
        try {
            ...
            WebElement congratsMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
            ...
            WebElement logoutButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
